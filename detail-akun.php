...
<div class="hero_area">
    ...
    <table class="center-table" style="border-collapse: collapse;">
        <tr>
            <td colspan="2" class="text-center"><img src="assets/ava-icon-dark-removebg-preview.png" alt="Gambar Atas"
                    style="width:150px; height:auto">
                <h1 style="font-size: 25px;">Egidia kusumadewi</h1><br>
            </td>
        </tr>

        <tr>
            <td colspan="2" style="text-align: center; padding-top: 3px; padding-bottom:30px">
        ...
        <tr>
            <td class="text-center" >
                <p>Barcode Saya</p><br>
                <img src="assets/barcode.jpg" alt="Gambar Bawah Kiri" style="width:100px; height:auto">
            </td>
            <td class="text-center">
                <p style="margin-left: 150px;">Koin Saya</p><br>
                <div class="image-text-container">
                    <img src="assets/coins1.png" alt="Gambar Bawah Kanan"
                        style="width:100px; height:auto; margin-left:150px">
                    <p style="font-weight: 600;">10 Koin</p>
                </div>
            </td>
        </tr>
    </table><br><br><br>
