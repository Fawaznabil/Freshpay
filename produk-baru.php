                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="text-center">
                                <img src="assets/latar.png" class="avatar img-circle img-thumbnail" alt="avatar">
                                <h6>Gambar Produk</h6>
                                <br>
                                <input type="file" id="file-input" style="display: none; ">
                                <button type="button" onclick="document.getElementById('file-input').click()"
                                    class="btn btn-primary" style="border-radius: 20px; font-size:15px; background-color:#35526b" >Pilih File</button>
                                <br><br><br>
                                <a href="/produk-login" button type="button" class="btn btn-warning" style="margin-left: 530px; border-radius:30px; font-size:14px">Simpan</a></button>
                            </div>
                        </div>

                        <div class="col-md-9 personal-info">
                            <form class="form-horizontal" role="form" style="margin-left: 100px;">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label"
                                        style=" font-weight: 600; margin-bottom:10px;">Nama Produk:</label>
                                    <div class="col-lg-8">
                                        <input class="form-control" type="text"
                                            style="color: rgb(154, 151, 151);  border-radius: 12px;"
                                            value="Tulis nama produk">
                                    </div>
                                </div><br>

                                <div class="form-group">
                                    <label class="col-lg-3 control-label"
                                        style=" font-weight: 600; margin-bottom:10px;">Harga Produk:</label>
                                    <div class="col-lg-8">
                                        <input class="form-control" type="text"
                                            style="color: rgb(154, 151, 151); border-radius: 12px; "
                                            value="Tulis harga produk">
                                    </div>
                                </div><br>

                                <div class="form-group">
                                    <label class="col-lg-3 control-label"
                                        style=" font-weight: 600; margin-bottom:10px;">Link Toko:</label>
                                    <div class="col-lg-8">
                                        <input class="form-control" type="text"
                                            style="color: rgb(154, 151, 151); border-radius: 12px;"
                                            value="Masukan link toko">
                                    </div>
                                </div>
                            </form>
                        </div>
